...
class My extends TagLib {
    ...
    protected $tags=array(
        ...
        'bootstraptable'=>array('','close'=>0),
        'suicss'=>array('','close'=>0),
        'suijs'=>array('','close'=>0),
        'validationjs'=>array('','close'=>0),
        'formjs'=>array('','close'=>0),
        'datetimepickerjscss'=>array('','close'=>0),
        'jqueryuijscss'=>array('','close'=>0),
        'autocompletejscss'=>array('','close'=>0),
...
php;
    ...
    // bootstrap-table标签
    public function _bootstraptable($tag,$content) {
        $link=<<<php
<!-- 引入bootstrap-table部分开始 -->
<link rel="stylesheet" href="__PUBLIC__/statics/bootstrap-table/dist/bootstrap-table.min.css" />
<script src="__PUBLIC__/statics/bootstrap-table/dist/bootstrap-table.min.js"></script>
php;
    return $link;
    }
...
php;
    ...
    // validationjs标签
    public function _validationjs($tag,$content) {
        $link=<<<php
<!-- 引入jquery-validation部分开始 -->
<!-- <script src="__PUBLIC__/statics/js/validation/jquery.validate.min.js"></script> -->
<script src="__PUBLIC__/statics/js/validation/jquery.validate.js"></script>
<script src="__PUBLIC__/statics/js/validation/additional-methods.js"></script>
<script src="__PUBLIC__/statics/js/validation/messages_zh.js"></script>
php;
    return $link;
    }
    ...
    public function _formjs($tag,$content) {
        $link=<<<php
<script src="__PUBLIC__/statics/js/jquery.form.js"></script>
php;
    return $link;
    }

    // datetimepicker标签
    public function _datetimepickerjscss($tag,$content) {
        $link=<<<php
<!-- 引入jquery-datetimepicker部分开始 -->
<link rel="stylesheet" type="text/css" href="__PUBLIC__/statics/datetimepicker/jquery.datetimepicker.css" />
<script src="__PUBLIC__/statics/datetimepicker/build/jquery.datetimepicker.full.min.js"></script>
...
php;
    ...
    // jqueryuijscss标签
    public function _jqueryuijscss($tag,$content) {
        $link=<<<php
<!-- 引入jquery-ui部分开始 -->
<link rel="stylesheet" type="text/css" href="__PUBLIC__/statics/jquery-ui-1.12.1/jquery-ui.min.css" />
<link rel="stylesheet" type="text/css" href="__PUBLIC__/statics/jquery-ui-1.12.1/jquery-ui-mine.css" />
<script src="__PUBLIC__/statics/jquery-ui-1.12.1/jquery-ui.min.js"></script>
php;
    return $link;
    }

    // autocompletejscss标签
    public function _autocompletejscss($tag,$content) {
        $link=<<<php
<!-- 引入jquery-autocomplete插件开始 -->
<link rel="stylesheet" type="text/css" href="__PUBLIC__/statics/jQueryAutocompletePlugin/jquery.autocomplete.css" />
<script src="__PUBLIC__/statics/jQueryAutocompletePlugin/jquery.autocomplete.js"></script>
php;
    return $link;
    }
