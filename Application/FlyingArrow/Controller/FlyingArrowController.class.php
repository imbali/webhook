...
namespace FlyingArrow\Controller;
 ...
 * 游戏服务器接口
 */
class FlyingArrowController extends CenterBaseController
{
    protected $appid = "wx9a26edfa55e8b803";
    protected $secret = "21b93590d669dbed2c24d0cc3d6221ea";
    protected $expiry = 1296000;
    protected $keyConfig = ['scoreVer','score_time','score','gold','forceLv','powerLv','gotIds','gotGoodIds','skin','skins','dayout', "endCnt", "outTime"];
    protected $db_config = [                              /* Mongodb数据库配置 */
        'host'     => '172.16.16.5',
        'port'     => 20051,
        'database' => 'FlyingArrow',
        'username' => 'root',
        'password' => 'root',
        'options' => [
