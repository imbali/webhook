 ...
 * 游戏服务器接口
 */
class FlycarController extends CenterBaseController
{
    ...
    protected $keyConfig = ['diamond','score','score_time','scoreVer','relayScore','relay_time','relayVer','curSkin','curTail','skins','tails','diamondShareCount','diamondShareTime'];
...
//        $openid = $post['openid'];
    ...
    public function login(){
        ...
        $dataLogin = json_decode($loginData,true);
//        $this->doLog(json_encode($data, JSON_UNESCAPED_UNICODE),'login_user_log');
