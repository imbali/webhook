...
namespace TheFisherCat\Controller;
 ...
 * 游戏服务器接口
 */
class TheFisherCatController extends CenterBaseController
{
    protected $appid = "wx32dde26f486881ef";
    protected $secret = "8ce3998105cab76554f87a113c9d2145";
    protected $expiry = 1296000;
    protected $keyConfig = ['dayout','loginCount','playTimes','lastLoginTime','coin','parts','curUsingGun','curOxyGan','gunList','lastOfflineRewardTime', 'fishList', 'stageList', 'stageRewardList'];
    protected $db_config = [                              /* Mongodb数据库配置 */
        'host'     => '172.16.16.5',
        'port'     => 20051,
        'database' => 'TheFisherCat',
        'username' => 'root',
        'password' => 'root',
        'options' => [
