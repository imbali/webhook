...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/Public/app/public/css/login.css" media="all">
        <link rel="stylesheet" type="text/css" href="/Public/app/public/css/google_color.css" media="all">
    </head>
    <body id="login-page">
        <div id="main-content">
            ...
            <div class="login-body">
                <div class="login-main pr">
                    <form action="<?php echo U(MODULE_NAME.'/Public/login');?>" method="post" class="login-form">
                        ...
                        <div id="itemBox" class="item-box">
                            ...
                            <div>
                                <img class="verifyimg reloadverify" alt="点击切换" src="<?php echo U('Admin/Public/verify');?>">
                            </div>
                        </div>
    ...
    <!--[if lt IE 9]>
    <script type="text/javascript" src="/Public/statics/aceadmin/js/jquery-1.10.2.min.js"></script>
    <![endif]-->
    <!--[if gte IE 9]><!-->
    <script type="text/javascript" src="/Public/statics/aceadmin/js/jquery-2.0.3.min.js"></script>
    <!--<![endif]-->
