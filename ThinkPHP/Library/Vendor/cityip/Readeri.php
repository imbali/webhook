...
class Readeri
{
     ...
     *                                                     from it
     */
    public function __construct($database=__DIR__.'/GeoLite2-City.mmdb')
    {
//        if (func_num_args() !== 1) {
...
//            );
//        }
        Vendor('cityip.Decoder');
        Vendor('cityip.Util');
        Vendor('cityip.InvalidDatabaseException');
        Vendor('cityip.Metadata');
